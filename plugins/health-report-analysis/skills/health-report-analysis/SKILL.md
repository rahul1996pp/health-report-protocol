...
description: Analyze a folder of personal medical reports (blood/urine labs, imaging, ECG/Echo/TMT, prescriptions, eye reports) and produce a traceable extraction, trend analysis, finding interlinks, and a single self-contained OFFLINE HTML dashboard a non-medical person can understand. Use when the user has medical reports, lab results, scans, or prescriptions to organize or understand, or asks for a health dashboard or report analysis. Never diagnoses; explains in plain language; keeps all data on the user's machine.
allowed-tools: Read, Write, Edit, Bash, Glob, Grep
user-invocable: true
---

> **This skill packages the protocol below.** Where the text says "drop this file" or
> "CLAUDE.md", treat it as *this skill's instructions*. Follow the phases in order, pause for
> confirmation after Discovery (Phase 0), and ask about unclear items one at a time.
